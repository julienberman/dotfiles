...
return {
	...
	-- 			{ fg = palette.base, bg = palette.lavender, bold = true }
	-- 		)
	...
	-- 		vim.api.nvim_set_hl(
	-- 			0,
	-- 			"MiniStatuslineModified",
	-- 			{ fg = palette.lavender, bg = palette.surface0, bold = true }
	-- 		)
	...
	-- 		vim.api.nvim_set_hl(
	-- 			0,
	-- 			"MiniStatuslineRecordingRegister",
	-- 			{ fg = palette.peach, bg = palette.surface0, bold = true }
	-- 		)
	--
	...
	-- 			local location_visible = show_location
	-- 					and ((show_location_gap and " " or "") .. location_numbers .. " ")
	-- 				or ""
