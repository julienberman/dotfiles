...
hl.bind(main_mod .. " + G", hl.dsp.exec_cmd(file_manager))
...
hl.bind(main_mod .. " + Z", hl.dsp.send_shortcut({mods = "CTRL", key = "Z"}))
hl.bind(main_mod .. " + A", hl.dsp.send_shortcut({mods = "CTRL", key = "A"}))
hl.bind(main_mod .. " + F", hl.dsp.send_shortcut({mods = "CTRL", key = "F"}))

hl.bind(
    main_mod .. " + E",
    hl.dsp.exec_cmd("hyprshot -m region -o " .. path_hyprshot)
)
...
hl.define_submap("dragwindow", function()
    ...
    hl.bind(main_mod .. " + tab", hl.dsp.window.move({workspace = "e+1"}))
...
hl.bind(main_mod .. " + mouse:272", hl.dsp.submap("dragwindow"))

hl.bind(
    "SUPER + V",
    hl.dsp.exec_cmd("uwsm app -- ghostty --class clipse -e clipse")
)
hl.bind(
